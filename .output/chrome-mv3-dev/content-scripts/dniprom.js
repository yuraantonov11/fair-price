var dniprom = (function() {
	//#region node_modules/wxt/dist/utils/define-content-script.mjs
	function defineContentScript(definition) {
		return definition;
	}
	//#endregion
	//#region src/entrypoints/dniprom.content/index.tsx
	var dniprom_content_default = defineContentScript({
		matches: [],
		main() {}
	});
	//#endregion
	...
	*/
	function getUniqueEventName(eventName) {
		return `${browser?.runtime?.id}:dniprom:${eventName}`;
	}
	//#endregion
	...
	*/
	...
	//#endregion
	//#region \0virtual:wxt-content-script-isolated-world-entrypoint?C:/Users/yuraa/WebstormProjects/fair_price/src/entrypoints/dniprom.content/index.tsx
	...
	return (async () => {
		try {
			const { main, ...options } = dniprom_content_default;
			return await main(new ContentScriptContext("dniprom", options));
		} catch (err) {
			logger.error(`The content script "dniprom" crashed on startup!`, err);
			throw err;
		}
	})();
})();
